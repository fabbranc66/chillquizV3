...
(() => {
  ...
  Admin.dom = {
    ...
    qaReplacePanel: document.getElementById('qa-replace-panel'),
    qaReplaceCurrent: document.getElementById('qa-replace-current'),
    qaReplaceSearch: document.getElementById('qa-replace-search'),
    qaReplaceArgomento: document.getElementById('qa-replace-argomento'),
    qaReplaceTipo: document.getElementById('qa-replace-tipo'),
    qaReplaceResults: document.getElementById('qa-replace-results'),
    btnQaReplaceSearch: document.getElementById('btnQaReplaceSearch'),
    btnQaReplaceClose: document.getElementById('btnQaReplaceClose'),
